/* 5.You are working for an e-commerce client, and they provide you with an array of objects containing product
...
console.log(`The product whith Maximum amount is ${maxProduct.name} which is priced at = ${maxProduct.price}`);
